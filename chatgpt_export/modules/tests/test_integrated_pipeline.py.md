# Module: `tests\test_integrated_pipeline.py`
Hash: `9ebc535546c5` · LOC: 10 · Main guard: true
...
## Functions
- `test_integrated_pipeline()` (L18): Test complete pipeline with video

## Intra-module calls (heuristic)
CalibrationManager, DartDetectorConfig, DartImpactDetector, FPSCounter, MotionConfig, MotionDetector, Path, ROIConfig, ROIProcessor, VideoCapture, addWeighted, append, circle, cvtColor, destroyAllWindows, detect_dart, detect_motion, enumerate, get_confirmed_impacts, get_homography, get_stats, imshow, insert, isOpened, is_valid, len, ord, print, putText, read, release, resize, set_homography_from_matrix, str, test_integrated_pipeline, update, waitKey, warp_roi
